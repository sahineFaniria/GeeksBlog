      ...
      <main className="pt-16 h-full flex">
        ...
        <aside className="w-1/4 p-4 border-l overflow-y-auto">
          <div className="bg-blue-50 border border-blue-200 rounded p-4 text-sm space-y-3">
            ...
            <p>
              Pour profiter pleinement de GeeksBlog, créez un compte gratuitement !
            </p>
            ...
            <p className="font-semibold text-blue-800 mt-4">N’attendez plus, rejoignez la communauté dès maintenant !</p>
          </div>
        </aside>
      </main>
    </div>
